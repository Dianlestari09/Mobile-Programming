...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const LocationScreen(), // Menggunakan LocationScreen
    );
  }
}

// g. Buat kelas LocationScreen
class LocationScreen extends StatefulWidget {
  const LocationScreen({super.key}); // Disesuaikan dari GeolocationScreen

  @override
  State<LocationScreen> createState() => _LocationScreenState(); // Disesuaikan dari _GeolocationScreenState
}
...
class _LocationScreenState extends State<LocationScreen> {
  ...
  // i. Buat tampilan UI di method build()
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
